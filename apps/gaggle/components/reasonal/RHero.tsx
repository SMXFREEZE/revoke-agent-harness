        ...
        <div className="rz-hero__inner">
          ...
          <div className="rz-phone">
            ...
            <div className="rz-phone__screen">
              <video className="rz-phone__media" src={publicAssetPath("hero/microbiome.mp4")} poster={publicAssetPath("hero/ai-microbiome.webp")} autoPlay loop muted playsInline aria-hidden />
