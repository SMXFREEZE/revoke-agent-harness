        ...
        <div className="rz-card-w rz-grid12">
          ...
          >
            ...
            <div className="rz-feat__media rz-feat__media--fade" data-reveal>
              ...
              <img src={publicAssetPath("images/tulum/feat-mentor.jpg")} alt="A scientist reviewing microbiome evidence" loading="lazy" />
            </div>
          </article>
          ...
          >
            ...
            <div className="rz-feat__media rz-feat__media--fade" data-reveal>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={publicAssetPath("images/tulum/feat-community.jpg")} alt="A research team reviewing experimental results" loading="lazy" />
            </div>
          </article>
        </div>
      </section>
